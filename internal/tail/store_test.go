...
func TestTailStore_RefreshFromObjectStorage(t *testing.T) {
	...
	store.objects["vex/namespaces/test-ns/wal/00000000000000000002.wal.zst"] = data2
...
func TestTailStore_NVMeTier(t *testing.T) {
	...
	cacheKey := cache.CacheKey{
		ObjectKey: "vex/namespaces/test-ns/wal/00000000000000000001.wal.zst",
		ETag:      "",
	}
...
func TestTailStore_ScanWithByteLimit(t *testing.T) {
	...
	store.objects["vex/namespaces/test-ns/wal/00000000000000000001.wal.zst"] = data1
	...
	store.objects["vex/namespaces/test-ns/wal/00000000000000000003.wal.zst"] = data3
...
func TestTailStore_ByteLimitNewestFirstOrdering(t *testing.T) {
	...
	for i := uint64(1); i <= 5; i++ {
		...
		// KeyForSeq returns "wal/<zero-padded seq>.wal.zst", so the full key is "vex/namespaces/test-ns/" + KeyForSeq(i)
